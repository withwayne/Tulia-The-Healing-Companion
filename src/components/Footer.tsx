const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-muted/30 to-background py-12 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        {/* Floating Hearts */}
        <div className="absolute bottom-20 left-1/4 w-4 h-4 text-primary/30 animate-float" style={{ animationDelay: '1s' }}>
          <svg fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
          </svg>
        </div>
        <div className="absolute bottom-32 right-1/3 w-3 h-3 text-accent/40 animate-float" style={{ animationDelay: '2s' }}>
          <svg fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
          </svg>
        </div>
